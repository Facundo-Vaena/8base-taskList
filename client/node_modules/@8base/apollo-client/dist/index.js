...
function (_ApolloClient) {
  ...
  function EightBaseApolloClient(config) {
    ...
    var uri = config.uri,
        ...
        _config$withAuth = config.withAuth,
        withAuth = _config$withAuth === void 0 ? true : _config$withAuth,
        rest = (0, _objectWithoutProperties2.default)(config, ["uri", "getAuthState", "getRefreshTokenParameters", "onAuthSuccess", "onAuthError", "onIdTokenExpired", "onRequestSuccess", "onRequestError", "extendLinks", "withAuth"]);
    ...
    if (withAuth) {
      ...
      links = [authLink].concat((0, _toConsumableArray2.default)(links));
    }
