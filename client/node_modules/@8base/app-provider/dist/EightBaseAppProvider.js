...
var EightBaseAppProvider = function EightBaseAppProvider(_ref) {
  ...
  return !!authClient ? _react.default.createElement(_auth.AuthProvider, {
  ...
  }, _react.default.createElement(_tableSchemaProvider.TableSchemaProvider, null, children))) : _react.default.createElement(_ApolloContainer.ApolloContainer, {
    withAuth: false,
    uri: uri,
    extendLinks: extendLinks,
    onRequestSuccess: onRequestSuccess,
