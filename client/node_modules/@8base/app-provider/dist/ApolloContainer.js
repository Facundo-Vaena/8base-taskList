...
function (_React$Component) {
  ...
  function ApolloContainer() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "createClient", R.memoizeWith(R.identity, function (fragmentsSchema) {
      var withAuth = _this.props.withAuth;
      var commonOptions = {
        uri: _this.props.uri,
      ...
      return withAuth ? new _apolloClient.EightBaseApolloClient((0, _objectSpread2.default)({}, commonOptions, {
        getAuthState: _this.getAuthState,
        onAuthError: _this.onAuthError,
        withAuth: true
      })) : new _apolloClient.EightBaseApolloClient((0, _objectSpread2.default)({}, commonOptions, {
        withAuth: false
      }));
    }));
...
(0, _defineProperty2.default)(ApolloContainer, "defaultProps", {
  auth: {},
  withAuth: true
});
