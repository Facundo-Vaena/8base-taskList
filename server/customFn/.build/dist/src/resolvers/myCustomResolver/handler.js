...
var COMPLETE_TODO_RESOLVER = graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n mutation ($id: ID!, $text: String!, $completed: Boolean!) {\n     todoUpdate(filter: { id: $id }, \n         data: {completed: $completed, text: $text}\n     \n         ) {\n             id\n             text\n             completed\n     }\n }\n "], ["\n mutation ($id: ID!, $text: String!, $completed: Boolean!) {\n     todoUpdate(filter: { id: $id }, \n         data: {completed: $completed, text: $text}\n     \n         ) {\n             id\n             text\n             completed\n     }\n }\n "])));
module.exports = function (event, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ctx.api.gqlRequest(COMPLETE_TODO_RESOLVER, { id: event.data.id, text: event.data.text, completed: event.data.completed })];
            case 2:
                response = _a.sent();
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                return [2 /*return*/, { data: { success: false, messagge: "Something went wrong" } }];
            case 4: return [2 /*return*/, { data: { success: true, messagge: "Task Updated" } }];
        }
    });
}); };
